...
urlpatterns = [
    ...
    path('api/viagem/<int:viagem_id>/convites/<int:convite_id>/reenviar/', views.reenviar_convite, name='api_reenviar_convite'),
    path('api/viagem/<int:viagem_id>/convites/<int:convite_id>/cancelar/', views.cancelar_convite, name='api_cancelar_convite'),
    path('api/viagem/<int:viagem_id>/membros/<int:membro_id>/toggle-admin/', views.alternar_admin, name='api_alternar_admin'),
    path('api/viagem/<int:viagem_id>/membros/<int:membro_id>/remover/', views.remover_membro, name='api_remover_membro'),
]