...
// Importando a Sidebar GLOBAL (Note o caminho voltando pastas: ../../)
...
const TripDashboard = () => {
  ...
  return (
    <div className="dashboard-layout">
      {/* Usamos a Sidebar Global aqui.
          Passamos a prop activeTab="Roteiro" (ou outra) para destacar o ícone correto 
      */}
      <Sidebar activeTab="Roteiro" />

      <main className="main-content">
        {/* --- HEADER --- */}
        {/* Mantive seu header pois ele tem botões específicos da viagem */}
