    ...
    fetch(`${API_BASE_URL}/planner/api/viagens/`, {
      ...
      .then((data) => {
        ...
        const mapped = data.map((v) => ({
          ...v,
          status_display:
            v.status === "CONCLUIDA" ? "Concluída" : "Em Planejamento", // Exemplo simples
        ...
        >
          ...
          >
            <div className="dash-title">
              ...
              <p style={{ color: "#6b7280", margin: 0 }}>
                Gerencie todas as suas aventuras.
              </p>
            </div>
            <button
          ...
          <main className="mytrips-content" style={{ padding: "2rem" }}>
            ...
            {loading ? (
              ...
              >
                <span className="empty-icon" style={{ fontSize: "2rem" }}>
                  😢
                </span>
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          viagem.imagem
                            ? `${API_BASE_URL}${viagem.imagem}` // Se tiver imagem no banco, usa ela
                            : `https://source.unsplash.com/800x600/?travel,${viagem.titulo}` // Se não, busca uma aleatória baseada no título
                        }
                        className="card-img"
                        alt={viagem.titulo}
                        style={{
                        ...
                        onError={(e) => {
                          // Fallback final: Imagem do barco (padrão) caso a URL acima falhe
                          e.target.src =
                    ...
                    <div className="card-info" style={{ padding: "1.25rem" }}>
                      ...
                      >
                        ...
                        >
                          <Users size={14} /> {viagem.participantes_count}{" "}
                          membros
                        </div>
                      </div>
                    </div>
